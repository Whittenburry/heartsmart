...
const instacartRoutes: FastifyPluginAsync = async (server: FastifyInstance) => {
  server.post<{ Body: { ingredients: string[] } }>('/api/create-shopping-link', async (request, reply) => {
...
export default instacartRoutes
